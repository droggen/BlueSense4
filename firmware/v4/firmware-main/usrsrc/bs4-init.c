...
//#endif
	...
	//stm_sdm_setinitparam(2,1);			// Initialisation for 48MHz bus (24MHz SDIO)
	//stm_sdm_setinitparam(1,1);			// Initialisation for 48MHz bus (48MHz SDIO)
	stm_sdm_setinitparam(0,1);				// Initialisation
