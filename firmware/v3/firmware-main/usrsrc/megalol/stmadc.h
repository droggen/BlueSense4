...
//#define STM_ADC_BUFFER_NUM		32				// Number of buffers
#define STM_ADC_BUFFER_NUM		128					// Number of buffers
#define STM_ADC_BUFFER_MASK		(STM_ADC_BUFFER_NUM-1)
#define STM_ADC_MAXCHANNEL		10					// Maximum number of channels in a scan conversion. In BS4: 5 GPIO channels and 4 internal channels -> safety margin
